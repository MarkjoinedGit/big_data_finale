...
if __name__ == "__main__":
    ...
    # Input path
    input_path = os.path.join(absolute_path, 'input/input_47.csv')

    # Output paths
    output_path = os.path.join(absolute_path, 'output', 'exercise-47')
    output_df_path = os.path.join(output_path, 'result_dataframe_mode')
    output_sql_path = os.path.join(output_path, 'result_sql_mode')
