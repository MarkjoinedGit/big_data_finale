...
if __name__ == "__main__":
    ...
    # Input path
    input_path = os.path.join(absolute_path, 'input/input_48.csv')

    # Output paths
    output_df_path = os.path.join(absolute_path, 'output/exercise-48/result_dataframe_mode')
    output_sql_path = os.path.join(absolute_path, 'output/exercise-48/result_sql_mode')
