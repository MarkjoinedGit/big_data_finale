...
if __name__ == "__main__":
    ...
    # Input path
    input_path = os.path.join(absolute_path, 'input/input_32.csv')
    ...
    # Output path
    output_path = os.path.join(absolute_path, 'output','exercise-32')

    # Save data on the output file
    sc.parallelize([max_temp]).coalesce(1).saveAsTextFile(output_path)
